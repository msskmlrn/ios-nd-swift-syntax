...
let yourSentence = "This is a \(nounArray[1])"
let index = Int(arc4random() % 9)
let yourSillySentence = "something \(nounArray[index]) test"
//: ### Exercise 2
...
let result = "HEY! " + didYouKnowString.uppercased()
//: ### Exercise 3
//: How many characters are in this string? 
let howManyCharacters = "How much wood could a woodchuck chuck if a woodchuck could chuck wood?"
let result2 = howManyCharacters.characters.count
//: ### Exercise 4
...
let resultString: String = "$" + "\(dollars)" + "," + "\(cents)"
