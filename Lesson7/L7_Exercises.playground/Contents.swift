...
var cookie = Cookie(flavor: "Vanilla", minutesSinceBaking: 0)
cookie.tempt()
...
class BedAndBreakfast {
    ...
    init(category: Housing, available: Bool, capacity: Int) {
...
var bAndB = BedAndBreakfast(category: .mansion, available: false, capacity: 10)
bAndB.book()